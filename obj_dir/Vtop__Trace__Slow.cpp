...
void Vtop::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+73,"top romAddress", false,-1, 15,0);
        tracep->declBus(c+10,"top ctrlOut", false,-1, 15,0);
        tracep->declBus(c+74,"top controlWord", false,-1, 31,0);
        tracep->declBus(c+61,"top aluOut", false,-1, 15,0);
        tracep->declBus(c+141,"top ramOut", false,-1, 15,0);
        tracep->declBus(c+143,"top romOut", false,-1, 15,0);
        tracep->declBus(c+144,"top gpuOut", false,-1, 15,0);
        tracep->declBus(c+145,"top apuOut", false,-1, 15,0);
        tracep->declBus(c+146,"top clkOut", false,-1, 15,0);
        tracep->declBus(c+66,"top bus", false,-1, 15,0);
        ...
        tracep->declBus(c+67,"top MEMbus", false,-1, 15,0);
        tracep->declBus(c+66,"top MEMout", false,-1, 15,0);
        tracep->declBus(c+37,"top uartOut", false,-1, 15,0);
        tracep->declBus(c+147,"top statusOut", false,-1, 15,0);
        tracep->declBus(c+148,"top addrstackOut", false,-1, 15,0);
        tracep->declBus(c+149,"top userstackOut", false,-1, 15,0);
        tracep->declBus(c+150,"top gpioOut", false,-1, 15,0);
        tracep->declBus(c+151,"top gpiodirOut", false,-1, 15,0);
        tracep->declBus(c+17,"top MEMstate", false,-1, 6,0);
        tracep->declBit(c+152,"top overflow", false,-1);
        tracep->declBus(c+38,"top aluStatus", false,-1, 5,0);
        tracep->declBus(c+153,"top testState", false,-1, 3,0);
        ...
        tracep->declBus(c+38,"top CONTROL aluStatus", false,-1, 5,0);
        tracep->declBit(c+8,"top CONTROL ramWrite", false,-1);
        tracep->declBus(c+40,"top CONTROL hreg", false,-1, 15,0);
        tracep->declBus(c+9,"top CONTROL ramAdd", false,-1, 15,0);
        tracep->declBus(c+73,"top CONTROL romAdd", false,-1, 15,0);
        tracep->declBus(c+10,"top CONTROL dout", false,-1, 15,0);
        tracep->declBus(c+74,"top CONTROL controlWord", false,-1, 31,0);
        tracep->declBus(c+154,"top CONTROL flags", false,-1, 4,0);
        tracep->declBus(c+18,"top CONTROL increment", false,-1, 2,0);
        tracep->declBit(c+19,"top CONTROL ramAddMode", false,-1);
        tracep->declBus(c+9,"top CONTROL ramAddReg", false,-1, 15,0);
        tracep->declBus(c+73,"top CONTROL programCounter", false,-1, 15,0);
        tracep->declBus(c+75,"top CONTROL opvar", false,-1, 1,0);
        tracep->declBus(c+76,"top CONTROL opcode", false,-1, 4,0);
        tracep->declBus(c+77,"top CONTROL operand1Wire", false,-1, 2,0);
        tracep->declBus(c+78,"top CONTROL operand2Wire", false,-1, 2,0);
        tracep->declBus(c+79,"top CONTROL resultsWire", false,-1, 2,0);
        tracep->declBus(c+80,"top CONTROL word2Wire", false,-1, 15,0);
        tracep->declBus(c+81,"top CONTROL conditions", false,-1, 5,0);
        tracep->declBus(c+142,"top CONTROL addrstackptr", false,-1, 7,0);
        tracep->declBit(c+82,"top ROM CLK", false,-1);
        tracep->declBus(c+73,"top ROM address", false,-1, 15,0);
        tracep->declBus(c+74,"top ROM data", false,-1, 31,0);
        tracep->declBit(c+82,"top ROM ROMDATA CLK", false,-1);
        tracep->declBus(c+73,"top ROM ROMDATA address", false,-1, 15,0);
        tracep->declBus(c+74,"top ROM ROMDATA data", false,-1, 31,0);
        tracep->declBus(c+74,"top ROM ROMDATA dintern", false,-1, 31,0);
        tracep->declBit(c+82,"top ALU CLK", false,-1);
        tracep->declBit(c+7,"top ALU readBus", false,-1);
        tracep->declBus(c+66,"top ALU din", false,-1, 15,0);
        tracep->declBus(c+61,"top ALU dout", false,-1, 15,0);
        ...
        tracep->declBus(c+38,"top ALU status", false,-1, 5,0);
        tracep->declBus(c+41,"top ALU a", false,-1, 15,0);
        tracep->declBus(c+42,"top ALU b", false,-1, 15,0);
        tracep->declBus(c+43,"top ALU c", false,-1, 15,0);
        tracep->declBus(c+44,"top ALU d", false,-1, 15,0);
        tracep->declBus(c+45,"top ALU e", false,-1, 15,0);
        tracep->declBus(c+46,"top ALU f", false,-1, 15,0);
        tracep->declBus(c+47,"top ALU g", false,-1, 15,0);
        tracep->declBus(c+40,"top ALU h", false,-1, 15,0);
        tracep->declBus(c+68,"top ALU addsub", false,-1, 16,0);
        tracep->declBus(c+69,"top ALU mult", false,-1, 16,0);
        tracep->declBus(c+70,"top ALU log", false,-1, 15,0);
        tracep->declBus(c+62,"top ALU lshift", false,-1, 15,0);
        tracep->declBus(c+63,"top ALU rshift", false,-1, 15,0);
        tracep->declBus(c+61,"top ALU operand1", false,-1, 15,0);
        tracep->declBus(c+64,"top ALU operand2", false,-1, 15,0);
        tracep->declBus(c+71,"top ALU combOperand2", false,-1, 15,0);
        tracep->declBit(c+82,"top RAM CLK", false,-1);
        tracep->declBus(c+9,"top RAM address", false,-1, 15,0);
        tracep->declBus(c+66,"top RAM dataIn", false,-1, 15,0);
        tracep->declBit(c+8,"top RAM write", false,-1);
        tracep->declBus(c+141,"top RAM dataOut", false,-1, 15,0);
        tracep->declBus(c+67,"top RAM memIn", false,-1, 15,0);
        tracep->declBus(c+66,"top RAM memOut", false,-1, 15,0);
        ...
        tracep->declBit(c+155,"top RAM writeToggle", false,-1);
        tracep->declBit(c+155,"top RAM writePulse", false,-1);
        tracep->declBit(c+20,"top RAM memmap", false,-1);
        tracep->declBit(c+82,"top UART CLK", false,-1);
        tracep->declBus(c+72,"top UART dataIn", false,-1, 7,0);
        tracep->declBit(c+21,"top UART write", false,-1);
        tracep->declBit(c+12,"top UART read", false,-1);
        tracep->declBus(c+37,"top UART dataOut", false,-1, 15,0);
        tracep->declBit(c+83,"top UART RX", false,-1);
        tracep->declBit(c+84,"top UART TX", false,-1);
        tracep->declBus(c+48,"top UART dataOutReg", false,-1, 7,0);
        tracep->declBit(c+156,"top UART uartread", false,-1);
        tracep->declBus(c+49,"top UART uartin", false,-1, 7,0);
        ...
        tracep->declBit(c+157,"top UART outfull", false,-1);
        tracep->declBit(c+50,"top UART TXfull", false,-1);
        tracep->declBit(c+51,"top UART TXempty", false,-1);
        tracep->declBit(c+52,"top UART RXfull", false,-1);
        tracep->declBit(c+53,"top UART RXempty", false,-1);
        tracep->declBit(c+54,"top UART sendState", false,-1);
        tracep->declBit(c+55,"top UART sendRead", false,-1);
        tracep->declBit(c+56,"top UART TXstart", false,-1);
        tracep->declBit(c+82,"top UART INFIFO CLK", false,-1);
        tracep->declBus(c+72,"top UART INFIFO dataIn", false,-1, 7,0);
        tracep->declBit(c+21,"top UART INFIFO write", false,-1);
        tracep->declBit(c+55,"top UART INFIFO read", false,-1);
        tracep->declBus(c+49,"top UART INFIFO dataOut", false,-1, 7,0);
        tracep->declBit(c+50,"top UART INFIFO full", false,-1);
        tracep->declBit(c+51,"top UART INFIFO empty", false,-1);
        tracep->declBus(c+57,"top UART INFIFO idx0", false,-1, 7,0);
        tracep->declBus(c+58,"top UART INFIFO idxn", false,-1, 7,0);
        ...
        tracep->declBus(c+49,"top UART UART TXbuffer", false,-1, 7,0);
        tracep->declBit(c+56,"top UART UART TXstart", false,-1);
        ...
        tracep->declBus(c+158,"top UART UART CLOCK_DIVISOR", false,-1, 31,0);
        ...
        tracep->declBit(c+65,"top UART OUTFIFO read", false,-1);
        tracep->declBus(c+48,"top UART OUTFIFO dataOut", false,-1, 7,0);
        tracep->declBit(c+52,"top UART OUTFIFO full", false,-1);
        tracep->declBit(c+53,"top UART OUTFIFO empty", false,-1);
        tracep->declBus(c+59,"top UART OUTFIFO idx0", false,-1, 7,0);
        tracep->declBus(c+60,"top UART OUTFIFO idxn", false,-1, 7,0);
...
void Vtop::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+18,(vlTOPp->top__DOT__CONTROL__DOT__increment),3);
        ...
        tracep->fullSData(oldp+37,((((IData)(vlTOPp->top__DOT__UART__DOT__RXempty) 
                                     << 0xbU) | (((1U 
                                                   == 
                                                   (0xffU 
        ...
        tracep->fullCData(oldp+38,(vlTOPp->top__DOT__aluStatus),6);
        tracep->fullIData(oldp+39,(vlTOPp->top__DOT__clkdiv),25);
        tracep->fullSData(oldp+40,(vlTOPp->top__DOT__ALU__DOT__h),16);
        tracep->fullSData(oldp+41,(vlTOPp->top__DOT__ALU__DOT__a),16);
        tracep->fullSData(oldp+42,(vlTOPp->top__DOT__ALU__DOT__b),16);
        tracep->fullSData(oldp+43,(vlTOPp->top__DOT__ALU__DOT__c),16);
        tracep->fullSData(oldp+44,(vlTOPp->top__DOT__ALU__DOT__d),16);
        tracep->fullSData(oldp+45,(vlTOPp->top__DOT__ALU__DOT__e),16);
        tracep->fullSData(oldp+46,(vlTOPp->top__DOT__ALU__DOT__f),16);
        tracep->fullSData(oldp+47,(vlTOPp->top__DOT__ALU__DOT__g),16);
        tracep->fullCData(oldp+48,(vlTOPp->top__DOT__UART__DOT__dataOutReg),8);
        tracep->fullCData(oldp+49,(vlTOPp->top__DOT__UART__DOT__uartin),8);
        tracep->fullBit(oldp+50,((1U == (0xffU & ((IData)(vlTOPp->top__DOT__UART__DOT__INFIFO__DOT__idx0) 
                                                  - (IData)(vlTOPp->top__DOT__UART__DOT__INFIFO__DOT__idxn))))));
        tracep->fullBit(oldp+51,(vlTOPp->top__DOT__UART__DOT__TXempty));
        tracep->fullBit(oldp+52,((1U == (0xffU & ((IData)(vlTOPp->top__DOT__UART__DOT__OUTFIFO__DOT__idx0) 
                                                  - (IData)(vlTOPp->top__DOT__UART__DOT__OUTFIFO__DOT__idxn))))));
        tracep->fullBit(oldp+53,(vlTOPp->top__DOT__UART__DOT__RXempty));
        tracep->fullBit(oldp+54,(vlTOPp->top__DOT__UART__DOT__sendState));
        tracep->fullBit(oldp+55,(vlTOPp->top__DOT__UART__DOT__sendRead));
        tracep->fullBit(oldp+56,(vlTOPp->top__DOT__UART__DOT__TXstart));
        tracep->fullCData(oldp+57,(vlTOPp->top__DOT__UART__DOT__INFIFO__DOT__idx0),8);
        tracep->fullCData(oldp+58,(vlTOPp->top__DOT__UART__DOT__INFIFO__DOT__idxn),8);
        tracep->fullCData(oldp+59,(vlTOPp->top__DOT__UART__DOT__OUTFIFO__DOT__idx0),8);
        tracep->fullCData(oldp+60,(vlTOPp->top__DOT__UART__DOT__OUTFIFO__DOT__idxn),8);
        tracep->fullSData(oldp+61,(vlTOPp->top__DOT__ALU__DOT__operand1),16);
        tracep->fullSData(oldp+62,(vlTOPp->top__DOT__ALU__DOT__lshift),16);
        tracep->fullSData(oldp+63,(vlTOPp->top__DOT__ALU__DOT__rshift),16);
        tracep->fullSData(oldp+64,(vlTOPp->top__DOT__ALU__DOT__operand2),16);
        tracep->fullBit(oldp+65,(vlTOPp->top__DOT__UART__DOT____Vcellinp__OUTFIFO__read));
        tracep->fullSData(oldp+66,(vlTOPp->top__DOT__bus),16);
        tracep->fullSData(oldp+67,(vlTOPp->top__DOT__MEMbus),16);
        tracep->fullIData(oldp+68,(vlTOPp->top__DOT__ALU__DOT__addsub),17);
        tracep->fullIData(oldp+69,(vlTOPp->top__DOT__ALU__DOT__mult),17);
        tracep->fullSData(oldp+70,(vlTOPp->top__DOT__ALU__DOT__log),16);
        tracep->fullSData(oldp+71,(vlTOPp->top__DOT__ALU__DOT__combOperand2),16);
        tracep->fullCData(oldp+72,((0xffU & (IData)(vlTOPp->top__DOT__MEMbus))),8);
        tracep->fullSData(oldp+73,(vlTOPp->top__DOT__CONTROL__DOT__programCounter),16);
        tracep->fullIData(oldp+74,(vlTOPp->top__DOT__ROM__DOT__ROMDATA__DOT__dintern),32);
        tracep->fullCData(oldp+75,((3U & vlTOPp->top__DOT__ROM__DOT__ROMDATA__DOT__dintern)),2);
        tracep->fullCData(oldp+76,((0x1fU & (vlTOPp->top__DOT__ROM__DOT__ROMDATA__DOT__dintern 
                                             >> 2U))),5);
        tracep->fullCData(oldp+77,((7U & (vlTOPp->top__DOT__ROM__DOT__ROMDATA__DOT__dintern 
                                          >> 7U))),3);
        tracep->fullCData(oldp+78,((7U & (vlTOPp->top__DOT__ROM__DOT__ROMDATA__DOT__dintern 
                                          >> 0xaU))),3);
        tracep->fullCData(oldp+79,((7U & (vlTOPp->top__DOT__ROM__DOT__ROMDATA__DOT__dintern 
                                          >> 0xdU))),3);
        tracep->fullSData(oldp+80,((0xffffU & (vlTOPp->top__DOT__ROM__DOT__ROMDATA__DOT__dintern 
                                               >> 0x10U))),16);
        tracep->fullCData(oldp+81,((0x3fU & (vlTOPp->top__DOT__ROM__DOT__ROMDATA__DOT__dintern 
                                             >> 7U))),6);
        ...
        tracep->fullCData(oldp+142,(vlTOPp->top__DOT__CONTROL__DOT__addrstackptr),8);
        tracep->fullSData(oldp+143,(vlTOPp->top__DOT__romOut),16);
        tracep->fullSData(oldp+144,(vlTOPp->top__DOT__gpuOut),16);
        tracep->fullSData(oldp+145,(vlTOPp->top__DOT__apuOut),16);
        tracep->fullSData(oldp+146,(vlTOPp->top__DOT__clkOut),16);
        tracep->fullSData(oldp+147,(vlTOPp->top__DOT__statusOut),16);
        tracep->fullSData(oldp+148,(vlTOPp->top__DOT__addrstackOut),16);
        tracep->fullSData(oldp+149,(vlTOPp->top__DOT__userstackOut),16);
        tracep->fullSData(oldp+150,(vlTOPp->top__DOT__gpioOut),16);
        tracep->fullSData(oldp+151,(vlTOPp->top__DOT__gpiodirOut),16);
        tracep->fullBit(oldp+152,(vlTOPp->top__DOT__overflow));
        tracep->fullCData(oldp+153,(0U),4);
        tracep->fullCData(oldp+154,(0U),5);
        tracep->fullBit(oldp+155,(0U));
        tracep->fullBit(oldp+156,(vlTOPp->top__DOT__UART__DOT__uartread));
        tracep->fullBit(oldp+157,(vlTOPp->top__DOT__UART__DOT__outfull));
        tracep->fullIData(oldp+158,(2U),32);
    }
}
